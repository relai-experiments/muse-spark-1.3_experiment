...
DATE_SUFFIX_PATTERN = re.compile(
    r"[-@]\d{4}-?\d{2}-?\d{2}$"
)  # -20251101 or @20251001 or -2026-03-05
...
FALLBACK_PRICING: dict[str, dict[str, float]] = {
    ...
    "gpt-5.5": {
        ...
        "cached_input_cost_per_token": 0.5e-6,
        "output_cost_per_token": 30e-6,
    },
    "gpt-5.5-pro": {"input_cost_per_token": 30e-6, "output_cost_per_token": 180e-6},
    # OpenRouter headline pricing for unpinned DeepSeek V4 Flash 0731 routing,
    # checked against OpenRouter models API on 2026-08-14.
    "deepseek-v4-flash-0731": {
        "input_cost_per_token": 0.14e-6,
        "cached_input_cost_per_token": 0.028e-6,
        "output_cost_per_token": 0.28e-6,
    },
    # OpenRouter non-discounted Xiaomi provider list pricing for MiMo V2.5,
    # checked against OpenRouter on 2026-08-17.
    "mimo-v2.5": {
        "input_cost_per_token": 0.14e-6,
        "cached_input_cost_per_token": 0.0028e-6,
        "output_cost_per_token": 0.28e-6,
    },
    # OpenRouter Meta provider pricing for Muse Spark 1.3,
    # checked against OpenRouter on 2026-09-04.
    "muse-spark-1.3": {
        "input_cost_per_token": 1.25e-6,
        "cached_input_cost_per_token": 0.15e-6,
    ...
    "claude-fable-5": {"input_cost_per_token": 10e-6, "output_cost_per_token": 50e-6},
    "claude-mythos-5": {"input_cost_per_token": 10e-6, "output_cost_per_token": 50e-6},
    # Sonnet 5 introductory pricing through 2026-08-31; becomes $3/$15 on 2026-09-01
    ...
    "gemini-3.1-flash-lite": {"input_cost_per_token": 0.25e-6, "output_cost_per_token": 1.5e-6},
...
class ModelPricing:
    ...
    def __post_init__(self) -> None:
        if self.cached_input_cost_per_token is None:
            self.cached_input_cost_per_token = self.input_cost_per_token
    ...
    def calculate_cost(
        ...
        *,
        ...
        return (
            ...
            + cached * self.cached_input_cost_per_token
    ...
    def _make_pricing(self, entry: dict, pricing_data: dict) -> ModelPricing | None:
        ...
        if "input_cost_per_token" in entry and "output_cost_per_token" in entry:
            ...
            return ModelPricing(
                ...
                source=source,
                cached_input_cost_per_token=entry.get(
                    "cached_input_cost_per_token",
    ...
    def get_pricing(self, model: str) -> ModelPricing | None:
        ...
        if self._input_cost_override is not None and self._output_cost_override is not None:
            return ModelPricing(
                ...
                source="cli-override",
                cached_input_cost_per_token=self._input_cost_override,
            )
